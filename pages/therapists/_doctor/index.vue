<template>
  <main id="therapist-details">
      ...
      <b-container fluid="lg" class="px-2 px-lg-0 text-center">
        ...
        >
          ...
          <b-col lg="4" class="text-capitalize">
            ...
            >
              <!-- 1 -->
              <b-col sm="5" lg="8" class="d-flex h-33 align-items-center mb-2">
                <!-- 1) - Rating -->
                <b-form-rating
                  v-model="rating"
                  class="p-0"
              ...
              >
                ...
                <div class="weight-bolder d-flex align-items-center">
                  <p class="m-0 text-20 weight-extraBold">200</p>
          ...
          >
            <!--  -->
            <p class="text-eightenth weight-extraBold text-25 text-capitalize">
              250 <span>{{ $t('placeHolder.egp') }}</span>
    ...
    <section>
      <b-container fluid="lg" class="px-2 px-lg-0">
        <b-row no-gutters class="text-capitalize">
          ...
          <p class="weight-light text-16 line-2 px-4 text-secondary">
    ...
    <section class="mt-lg-90">
      <b-container fluid="lg" class="px-2 px-lg-0 text-center text-capitalize">
        <!--  -->
        <h2 class="weight-bolder text-25 text-sevententh mx-auto my-5 mb-lg-52">
          certifications
        </h2>
        <!--  -->
